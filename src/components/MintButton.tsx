            ...
            <div className="flex flex-col w-full gap-4 lg:flex-row lg:items-center lg:gap-4 ">
                <div className="flex w-full px-2 border border-gray-400 rounded-lg h-11 dark:border-gray-800 md:w-full">
                    ...
                    <button
                        ...
                        className="flex items-center justify-center h-full px-2 text-2xl text-center rounded-r-md disabled:cursor-not-allowed disabled:text-gray-500 dark:text-white dark:disabled:text-gray-600"
                ...
                <Web3Button
                    ...
                    style={{
                        backgroundColor: colors[primaryColor as keyof typeof colors] || primaryColor,
                        maxHeight: "43px",
                    }}
                    theme={theme}
